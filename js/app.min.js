!function(e){function t(r){if(n[r])return n[r].exports;var i=n[r]={exports:{},id:r,loaded:!1};return e[r].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";var r,i,o,s,a=n(1),u=function(){r=0,i=0,o=0,s=0,a(".counter").removeClass("correct").removeClass("incorrect")},l=function(e){a("#q-text").text(e.questionText),a("#A").text(e.optionA),a("#B").text(e.optionB),a("#C").text(e.optionC),a("#D").text(e.optionD),e.newCorrect()},c=function(){u(),a(".entry").fadeOut(1e3),a(".question").show(),a(".answers").show(),f(),l(C[r]),a(".qa-head").text("Question "+(r+1)),a(".quiz-body").delay(1e3).fadeIn(1e3)},f=function(){a("#q"+(r+1)).addClass("current")},p=function(){a(".option").hasClass("picked")&&(a(".question").fadeOut(600),a(".answers").fadeOut(600),a(".option").removeClass("picked"),a("#gif").delay(600).fadeIn(100),i==o?(s++,a("#q"+(r+1)).removeClass("current").addClass("correct"),a(".qa-head").text("Correct!"),a("#gif").addClass("pos"+d())):(a("#q"+(r+1)).removeClass("current").addClass("incorrect"),a(".qa-head").text("Incorrect!"),a("#gif").addClass("neg"+d())))},d=function(){return Math.floor(4*Math.random())+1},h=function(){a("#gif").removeClass().hide(),r<C.length-1?(r++,f(),l(C[r]),a(".qa-head").text("Question "+(r+1)),a(".question").fadeIn(400),a(".answers").fadeIn(400)):(a(".qa-head").text(""),a(".score").text(s).show(200),a(".completed").show(200),a(".tryagain").show(200))};a(document).ready(function(){a(".entry").click(function(){c()}),a("body").on("click",".option",function(){a(".option").removeClass("picked"),a(this).addClass("picked")}),a("body").on("click",".confirm",function(){i=a(".picked").attr("id"),p()}),a("body").on("click","#gif",function(){h()}),a("body").on("click",".tryagain",function(){a(".score").hide(400),a(".completed").hide(400),a(".tryagain").hide(400),c()})});var g={questionText:"What is Prince's real name?",optionA:"Peter Ulversson",optionB:"Prince",optionC:"Prince Rogers Nelson",optionD:"Prince Nelson Rogers",newCorrect:function(){o="C"}},v={questionText:'Finish these Prince lyrics: "This is what it sounds like..."',optionA:"When love dies",optionB:"When doves cry",optionC:"When doves lie",optionD:"When gloves dry",newCorrect:function(){o="B"}},m={questionText:"On which album did the song 'Uptown' first appear?",optionA:"Sign 'O' The Times",optionB:"Purple Rain",optionC:"Lovesexy",optionD:"Dirty Mind",newCorrect:function(){o="D"}},y={questionText:"Prince's most recent band was called...",optionA:"T1m3FUNK",optionB:"TH1rd 3yE g1rL",optionC:"P.U.R.P.L.E.",optionD:"pr1nc3",newCorrect:function(){o="B"}},x={questionText:"Which of these is a Prince song?",optionA:"Dark Green Delorean",optionB:"Little Red Corvette",optionC:"Little Red Cadillac",optionD:"Mustang Sally",newCorrect:function(){o="B"}},b={questionText:"Prince won a Golden Globe for Best Song for a Movie, but what animated film was the song for?",optionA:"Happy Feet",optionB:"Finding Nemo",optionC:"Antz",optionD:"Up",newCorrect:function(){o="A"}},w={questionText:"What is the name of Prince's home and recording studio complex?",optionA:"Tartan Tower",optionB:"Check Castle",optionC:"Paisley Park",optionD:"Flannel Mansion",newCorrect:function(){o="C"}},T={questionText:"Which of these songs were written by Prince?",optionA:"Manic Monday",optionB:"Time After Time",optionC:"Ghostbusters",optionD:"With or Without You",newCorrect:function(){o="A"}},C=[g,v,m,y,x,b,w,T]},function(e,t,n){var r,i;/*!
